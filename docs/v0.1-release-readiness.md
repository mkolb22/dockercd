...
| Separate read-only Web monitoring | In progress | Owner workflow/accessibility validation, local-auth deployment proof, scoped controller-status/capacity evidence, and controller failure/restart evidence. |
